...
These are actual model-viewer screenshots, not in-game captures. The offline viewer includes all six updated meshes and three LODs. The [UI layout preview](personnel-relay-ui-0.5.2-preview.html) is a browser design reference, not native-game evidence.
