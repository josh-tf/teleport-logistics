...
- Travelling between Personnel Teleporters no longer freezes the game for around two seconds. Map and signal art was loaded on demand, so a journey triggered a blocking load while the destination was streaming in; all of it now resolves when the building is constructed.
